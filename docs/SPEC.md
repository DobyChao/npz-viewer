...
```
┌───────────────────────────────────────────────────────────────────────┐
│ TopBar: [root 下拉 + 管理] [面包屑] [后端] [色域] [中/EN] [设置]          │
├──────────────┬────────────────────────────────────────────────────────┤
...
3. 界面语言：**中文 / English**。顶栏与设置里可切换；首次打开跟随浏览器（`zh*` → 中文，否则英文），选择写入 localStorage。
...
| 2026-09-21 | 界面中英双语，默认跟随浏览器 | 顶栏/设置切换；文案进 `frontend/src/i18n` |
